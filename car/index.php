...
LUX автомобили 
        ...
        <div class="top__slider">
          ...
          <div class="top__slider-item">
            ...
            <p class="top__slider-text"><span>4 грн/мин</span> <span>5 мест</span> <span>50 тыс.км пробег</span>
           </p>
          </div>
        ...
        <div class="top__bottom">
          ...
          <div class="top__items">
            ...
            <div class="top__item">
              <img class="top__items-img" src="images/icon-1.svg" alt="">
  ...
  в вашем распоряжении
            ...
            <div class="top__item">
              <img class="top__items-img" src="images/icon-2.svg" alt="">
              <p class="top__item-text">
                Дешевле такси 
  и собственного автомобиля
            ...
            <div class="top__item">
              <img class="top__items-img" src="images/icon-3.svg" alt="">
              <p class="top__item-text">
    ...
    <div class="container">
      ...
      <div class="benefits__items">
        ...
        <div class="benefits__content">
          ...
          <a class="video-popup" data-fancybox href="https://www.youtube.com/watch&v=_sI_Ps7JSEk">ПОСМОТРЕТЬ<br> ПРЕЗЕНТАЦИЮ</a>
        </div>
...
Брал машину на свидание, покатал девушку, она в восторге, я доволен, все счастливы)
    ...
    <div class="container">
      ...
      <div class="feedback__inner">
        ...
        <img class="feedback__inner" src="images/feedback-img.png" alt="">

        <form class="feedback__form" action="send.php" method="post">
          ...
          <input class="feedback__input" type="text" name="tel" placeholder="Телефон">
